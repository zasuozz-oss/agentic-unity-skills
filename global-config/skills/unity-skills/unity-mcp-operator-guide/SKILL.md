---
name: unity-mcp-operator-guide
description: "Use when operating Unity Editor through MCP tools: execute_menu_item, select_gameobject, get_console_logs, run_tests, take_screenshot, or any direct MCP-to-Unity command."
---
