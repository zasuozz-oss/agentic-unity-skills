---
name: scripts-verify-checklist
description: Use when reviewing, auditing, or optimizing Unity C# scripts for performance — covers caching, GC allocations, coroutines, async/await safety, object pooling, DOTween, physics, UI code patterns, Addressables lifecycle, backend integration, debug logging, and ANR/crash prevention
---
