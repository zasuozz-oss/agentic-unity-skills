...
## When to Use
- Generate TCs from feature plan (output of `@qa-doc-parser`)
...
## Related Skills
- `@qa-doc-parser` — Parse documents/code before generating TCs
- `@qa-test-verifier` — Classify test results
- `@qa-test-scorer` — Detailed TC quality scoring
