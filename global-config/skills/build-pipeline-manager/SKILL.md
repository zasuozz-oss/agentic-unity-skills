...
description: "Build pipeline automation. Use this for CI/CD build scripts, automated builds for Android/iOS/Windows, Jenkins/GitHub Actions setup, build settings, platform switching, or build automation."
---
